...
export default function InterviewPage() {
  ...
  return <div className="home-page interview-page">
    ...
    {!active ? <section className="study-tip"><XCircle size={18} /><p>Không có câu hỏi khớp với bộ lọc. Hãy chọn Tất cả hoặc đổi chủ đề.</p></section> : <section className="practice-card">
      <div className="practice-meta"><span className="category-chip">{active.topic}</span><span className="weight-badge">{active.difficulty}</span><span className={secondsLeft <= 10 ? 'timer urgent' : 'timer'}><TimerReset size={16} /> 00:{String(secondsLeft).padStart(2, '0')}</span></div>
